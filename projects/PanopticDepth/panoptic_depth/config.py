...
def add_panoptic_depth_config(cfg):
    cfg.MODEL.TENSOR_DIM = 150
    ...
    cfg.MODEL.POSITION_HEAD.STUFF.NUM_CLASSES = 19
    cfg.MODEL.POSITION_HEAD.STUFF.WITH_THING = True
    cfg.MODEL.POSITION_HEAD.STUFF.ALL_CLASSES = True
    ...
    cfg.MODEL.FEATURE_ENCODER.CONVS_DIM = 256
    cfg.MODEL.FEATURE_ENCODER.DEFORM = True
    ...
    cfg.MODEL.DEPTH_HEAD.FACTOR     = 5.
    cfg.MODEL.DEPTH_HEAD.FACTOR_INS = 1.

    cfg.MODEL.LOSS_WEIGHT = CN()
    cfg.MODEL.LOSS_WEIGHT.POSITION_THING = 1.0
    cfg.MODEL.LOSS_WEIGHT.POSITION_STUFF = 1.0
    ...
    cfg.DATASETS.NAME = "CityscapesDPS"

    cfg.INPUT.COLOR_AUG = True
    cfg.INPUT.ROTATE_AUG = 0.
    cfg.INPUT.CROP.RESCALE = (-1., -1.)
